...
import com.activiti.system.domain.SysRoleDept;
import com.activiti.system.domain.SysRoleMenu;
import com.activiti.system.domain.SysUserRole;
import com.activiti.system.mapper.SysRoleDeptMapper;
import com.activiti.system.mapper.SysRoleMapper;
import com.activiti.system.mapper.SysRoleMenuMapper;
import com.activiti.system.mapper.SysUserRoleMapper;
import com.activiti.system.service.ISysRoleService;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public int deleteRoleByIds(String ids)
    {
        ...
        for (Long roleId : roleIds) {
            ...
            identityService.deleteGroup(String.valueOf(roleId));
            Group group = identityService.createGroupQuery().groupId(String.valueOf(roleId)).singleResult();
            if (group != null) {
                // 获取该组下所有用户的关联信息
    ...
    public int insertRole(SysRole role) {
        ...
        if (Objects.isNull(group)) {
            Group newGroup = identityService.newGroup(String.valueOf(role.getRoleId()));
